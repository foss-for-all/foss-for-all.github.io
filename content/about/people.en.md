...
{{< cards >}}
  ...
  {{< member-card github="ppiyakk2" link="https://github.com/ppiyakk2" title="Seongsoo Cho (Director)" subtitle="클라우드 서비스 제공회사의 클라우드 인프라 엔지니어로 근무하는 조성수입니다. 2014년 파이콘 한국 자원봉사 활동을 시작으로 오픈소스 커뮤니티에 참여하게 되었습니다. 지금은 파이썬 사용자 모임과 오픈인프라 한국 사용자 모임의 운영진으로 활동하며, 국내 파이썬과 오픈스택 생태계 활성화에 기여하고 있습니다. IT개발자들의 기술 교류 및 트워킹 행사를 기획하고 운영하는데 많은 경험이 있으며 좋은 사람들과 함께 행사를 만들어나가는 것이 인생의 취미입니다." >}}
  ...
  {{< member-card image="images/members/choi-kyounggeon.jpg" link="https://github.com/sideseal" title="Kyounggeon Choi (Member)" subtitle="우연한 계기로 오픈소스 활동에 참여하게 되어, 그 인연으로 리눅스 멀티미디어와 관련된 직업을 가지고 일하고 있습니다. 다 같이 무언가를 만들어가는 오픈소스 커뮤니티의 에너지와 그 안에 담긴 윤리적인 목표, 그리고 따듯한 사람들과 함께한다는 점이 좋아서 FOSS for All 회원으로 활동하게 되었습니다. 리눅스와 작은 기계를 다루는 기술을 활용하여 커뮤니티에 도움이 되는 일을 하고자 노력하고 있습니다. 인문학과 글쓰기를 좋아하고, 사람들과 협업하여 무언가를 만들어나가는 과정 자체도 정말 좋아합니다. FOSS for All 커뮤니티를 다양한 분야의 사람들이 누구나 편안하고 따듯하게 어울리며, 이것저것 즐겁게 도전해보는 공간으로 만들어 나가고 싶습니다." method="Fill" options="512x512 q85 webp Right" >}}
  <div class="ffa-member ffa-member--cta">
    ...
    <a class="ffa-cta-btn" href="/en/about/join/">Apply for membership</a>
  </div>
{{< /cards >}}
